...
public class PendingRequestsAdapter extends
    ...
    public PendingRequestsAdapter(Context context, List<PendingRequest> c) {
        requestList = c;
        mContext = context;
    }
    ...
    public PendingRequestsAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        PendingRequestsAdapter.ViewHolder viewHolder = new PendingRequestsAdapter.ViewHolder(contactView);
        return viewHolder;
    }

    // Involves populating data into the item through holder
    @Override
    public void onBindViewHolder(PendingRequestsAdapter.ViewHolder viewHolder, int position) {
