...
public class ConfirmedRequestAdapter extends
        RecyclerView.Adapter<ConfirmedRequestAdapter.ViewHolder> {
    ...
    private List<ConfirmedRequest> requestList;
    // Store the context for easy access
    private Context mContext;

    // Pass in the contact array into the constructor
    public ConfirmedRequestAdapter(Context context, List<ConfirmedRequest> c) {
        requestList = c;
        mContext = context;
    }
    ...
    @Override
    public ConfirmedRequestAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(ConfirmedRequestAdapter.ViewHolder viewHolder, int position) {
